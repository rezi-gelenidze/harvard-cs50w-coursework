...
Wikipedia like simple website implemented in Django.
articles are written in Markdown, saved in server filesystem (without using Database)

Youtube review: [watch](https://youtu.be/1SZrFeqQjaw)

## Preview

![preview gif](https://github.com/rezi-gelenidze/CS50W-Projects/blob/master/Previews/WikiPreview.gif)
